...
const NotFoundPage = () => {
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-graph-paper font-hand">
      <div className="bg-white dark:bg-gray-800 p-12 max-w-md w-full shadow-sketch text-center relative rotate-slight-1 rounded-sm border-2 border-dashed border-gray-300 dark:border-gray-600">
         {/* Tape */}
         ...
         <h1 className="text-8xl font-bold text-pencil dark:text-gray-200 mb-2 -rotate-2">404</h1>
         <h2 className="text-2xl font-bold text-gray-500 dark:text-gray-400 mb-6 rotate-1">这一页被撕了？</h2>
